namespace ExamPro.Winform
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.navPatients = new ExamPro.Winform.Base.NavButton();
            this.navGraph = new ExamPro.Winform.Base.NavButton();
            this.navExams = new ExamPro.Winform.Base.NavButton();
            this.navExit = new ExamPro.Winform.Base.NavButton();
