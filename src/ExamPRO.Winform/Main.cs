...
namespace ExamPro.Winform
{
    public partial class Main : Form
    {
        ...
        public Main()
        {
            ...
            Utils.ErrorHandling.Error += ErrorHandling_Error;
        ...
        {
            programToolStripMenuItem.Text = string.Format("Log ({0})", Utils.ErrorHandling.ErrorsCount);
        }
        ...
        private void OpenGraph()
        {
            ...
            if (graph == null)
            {
                graph = new ExamPro.Winform.Graphs.GraphRoot.GraphFrame();
            }
